...
// ４つのアイテム配置位置情報を生成
const itemWidth  = (pageWidth - pageMargin*2)/2 - gap/2
const itemHeight = (pageHeight - pageMargin*2)/2 - gap/2

const leftList = [(0 + pageMargin), (pageMargin + itemWidth + gap)]
const topList =  [(0 + pageMargin), (pageMargin + itemHeight + gap)]
...
const datasourceDir = Folder.desktop + '/datasource'
